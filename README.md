...
- Run `npm install` (installs Stripe for the serverless function)
- Deploy to Netlify — the function at `netlify/functions/create-payment-intent.js` will create PaymentIntents
